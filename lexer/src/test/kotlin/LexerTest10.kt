...
class LexerTest10 {
    ...
    fun `print statement 1_0`() {
        ...
        val expectedTokens = listOf(
            ...
            Token(TokenType.STRING, TokenValue.StringValue("Hello: "), 1, 7),
            Token(TokenType.SUM, TokenValue.StringValue("+"), 1, 17),
            Token(TokenType.NUMBER, TokenValue.NumberValue(3.0), 1, 19),
            Token(TokenType.RIGHT_PARENTHESIS, TokenValue.StringValue(")"), 1, 20),
            Token(TokenType.SEMICOLON, TokenValue.StringValue(";"), 1, 21),

            Token(TokenType.PRINT, TokenValue.StringValue("print"), 2, 1),
            Token(TokenType.LEFT_PARENTHESIS, TokenValue.StringValue("("), 2, 6),
            Token(TokenType.IDENTIFIER, TokenValue.StringValue("name"), 2, 7),
            Token(TokenType.RIGHT_PARENTHESIS, TokenValue.StringValue(")"), 2, 11),
